...
class ArticleController extends HomeController
{
    ...
    public function detail($id = 0, $p = 1)
    {
        ...
        $this->display($category['template_detail']);
    }
     ...
     * 攻略
     */
    public function strategy($p = 1, $cate = '41', $limit = 10)
    {
        ...
        $this->display("Article/lists/strategy");
    }

    /**
     *新闻
     */
    public function news($p = 1, $cate = '40', $limit = 10)
    {
        $catModel = new CategoryModel();
        $ids = $catModel->getChildrenId($cate);
        $docModel = new DocumentModel();
     ...
     *美景推荐
     */
    public function play($p = 1, $cate = '42', $limit = 10)
    {
        $catModel = new CategoryModel();
        $ids = $catModel->getChildrenId($cate);
        $docModel = new DocumentModel();
     ...
     *酒店住宿
     */
    public function live($p = 1, $cate = '47', $limit = 10)
    {
        $catModel = new CategoryModel();
        $ids = $catModel->getChildrenId($cate);
        $docModel = new DocumentModel();
     ...
     *休闲娱乐
     */
    public function yu($p = 1, $cate = '46', $limit = 10)
    {
        $catModel = new CategoryModel();
        $ids = $catModel->getChildrenId($cate);
        $docModel = new DocumentModel();
     ...
     *餐饮美食
     */
    public function eat($p = 1, $cate = '43', $limit = 10)
    {
        $catModel = new CategoryModel();
        $ids = $catModel->getChildrenId($cate);
        $docModel = new DocumentModel();
     ...
     *联系我们
     */
    public function contact($id = 120)
    {
        /* 标识正确性检测 */
        if (!($id && is_numeric($id))) {
            $this->error('文档ID错误！');
        ...
        $Document->where($map)->setInc('view');
        $this->assign('detail', $info);
        $this->display("Article/detail/news");
    }
